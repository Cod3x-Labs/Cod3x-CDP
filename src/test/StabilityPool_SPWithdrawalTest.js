...
contract(
  ...
  async (accounts) => {
    ...
    const mintCollateralAndApproveBorrowerOps = async (
      ...
      await collateral.approveInternal(
        user,
    ...
    describe("Stability Pool Withdrawal", async () => {
      ...
      beforeEach(async () => {
        ...
        collDecimals = await contracts.collateralConfig.getCollateralDecimals(
      ...
      it("withdrawFromSP(): Depositors with equal initial deposit withdraw correct compounded deposit and ETH Gain after one liquidation", async () => {
        ...
        const alice_ETHWithdrawn = th
          .getEventArgByName(txA, "CollateralGainWithdrawn", "_collAmount")
          .toString();
        const bob_ETHWithdrawn = th
          .getEventArgByName(txB, "CollateralGainWithdrawn", "_collAmount")
          .toString();
        const carol_ETHWithdrawn = th
          .getEventArgByName(txC, "CollateralGainWithdrawn", "_collAmount")
          .toString();
        ...
        assert.isAtMost(
          th.getDifference(alice_ETHWithdrawn, "33166666666667"),
          10000,
        );
        assert.isAtMost(
          th.getDifference(bob_ETHWithdrawn, "33166666666667"),
          10000,
        );
        assert.isAtMost(
          th.getDifference(carol_ETHWithdrawn, "33166666666667"),
          10000,
        );
      });
      ...
      it("withdrawFromSP(): Depositors with equal initial deposit withdraw correct compounded deposit and ETH Gain after two identical liquidations", async () => {
        ...
        assert.isAtMost(
          th.getDifference(alice_ETHWithdrawn, "66333333333333"),
          10000,
        );
        assert.isAtMost(
          th.getDifference(bob_ETHWithdrawn, "66333333333333"),
          10000,
        );
        assert.isAtMost(
          th.getDifference(carol_ETHWithdrawn, "66333333333333"),
          10000,
        );
      });
      ...
      it("withdrawFromSP():  Depositors with equal initial deposit withdraw correct compounded deposit and ETH Gain after three identical liquidations", async () => {
        ...
        assert.isAtMost(
          th.getDifference(alice_ETHWithdrawn, dec(99500, 9)),
          10000,
        );
        assert.isAtMost(
          th.getDifference(bob_ETHWithdrawn, dec(99500, 9)),
          10000,
        );
        assert.isAtMost(
          th.getDifference(carol_ETHWithdrawn, dec(99500, 9)),
          10000,
        );
      });
      ...
      it("withdrawFromSP(): Depositors with equal initial deposit withdraw correct compounded deposit and ETH Gain after two liquidations of increasing LUSD", async () => {
        ...
        // (0.5 + 0.7) * 99.5 / 3
        assert.isAtMost(
          th.getDifference(alice_ETHWithdrawn, dec(398, 11)),
          10000,
        );
        assert.isAtMost(
          th.getDifference(bob_ETHWithdrawn, dec(398, 11)),
          10000,
        );
        assert.isAtMost(
          th.getDifference(carol_ETHWithdrawn, dec(398, 11)),
          10000,
        );
      });
      ...
      it("withdrawFromSP(): Depositors with equal initial deposit withdraw correct compounded deposit and ETH Gain after three liquidations of increasing LUSD", async () => {
        ...
        // (0.5 + 0.6 + 0.7) * 99.5 / 3
        assert.isAtMost(
          th.getDifference(alice_ETHWithdrawn, dec(597, 11)),
          10000,
        );
        assert.isAtMost(
          th.getDifference(bob_ETHWithdrawn, dec(597, 11)),
          10000,
        );
        assert.isAtMost(
          th.getDifference(carol_ETHWithdrawn, dec(597, 11)),
          10000,
        );
      });
      ...
      it("withdrawFromSP(): Depositors with varying deposits withdraw correct compounded deposit and ETH Gain after two identical liquidations", async () => {
        ...
        assert.isAtMost(
          th.getDifference(carol_ETHWithdrawn, dec(995, 11)),
          100000,
        );
      });
      ...
      it("withdrawFromSP(): Depositors with varying deposits withdraw correct compounded deposit and ETH Gain after three identical liquidations", async () => {
        ...
        assert.isAtMost(
          th.getDifference(alice_ETHWithdrawn, "49750000000000"),
          10000,
        );
        assert.isAtMost(
          th.getDifference(bob_ETHWithdrawn, dec(995, 11)),
          10000,
        );
        assert.isAtMost(
          th.getDifference(carol_ETHWithdrawn, "149250000000000"),
          100000,
        );
      });
      ...
      */
        ...
        assert.isAtMost(
          th.getDifference(alice_ETHWithdrawn, "11447463383570"),
          1000000,
        );
        assert.isAtMost(
          th.getDifference(bob_ETHWithdrawn, "2610021651454043"),
          1000000,
        );
        assert.isAtMost(
          th.getDifference(carol_ETHWithdrawn, "74980885162385"),
          1000000,
        );
      });
      ...
      it("withdrawFromSP(): A, B, C Deposit -> 2 liquidations -> D deposits -> 1 liquidation. All deposits and liquidations = 100 LUSD.  A, B, C, D withdraw correct LUSD deposit and ETH Gain", async () => {
        ...
        const dennis_ETHWithdrawn = th
          .getEventArgByName(txD, "CollateralGainWithdrawn", "_collAmount")
          .toString();
        ...
        assert.isAtMost(
          th.getDifference(alice_ETHWithdrawn, "82916666666667"),
          10000,
        );
        assert.isAtMost(
          th.getDifference(bob_ETHWithdrawn, "82916666666667"),
          10000,
        );
        assert.isAtMost(
          th.getDifference(carol_ETHWithdrawn, "82916666666667"),
          10000,
        );

        assert.isAtMost(
          th.getDifference(dennis_ETHWithdrawn, "49750000000000"),
          10000,
        );
      });
      ...
      it("withdrawFromSP(): A, B, C Deposit -> 2 liquidations -> D deposits -> 2 liquidations. All deposits and liquidations = 100 LUSD.  A, B, C, D withdraw correct LUSD deposit and ETH Gain", async () => {
        ...
        assert.isAtMost(
          th.getDifference(alice_ETHWithdrawn, dec(995, 11)),
          10000,
        );
        assert.isAtMost(
          th.getDifference(bob_ETHWithdrawn, dec(995, 11)),
        ...
        assert.isAtMost(
          th.getDifference(dennis_ETHWithdrawn, dec(995, 11)),
          10000,
        );
      });
      ...
      */
        ...
        assert.isAtMost(
          th.getDifference(alice_ETHWithdrawn, "419563467492260"),
          100000,
        );
        assert.isAtMost(
          th.getDifference(bob_ETHWithdrawn, "139854489164086"),
          100000,
        );
        assert.isAtMost(
          th.getDifference(carol_ETHWithdrawn, "104890866873065"),
          100000,
        );
        assert.isAtMost(
          th.getDifference(dennis_ETHWithdrawn, "131691176470588"),
          100000,
        );
      });
      ...
      */
        ...
        assert.isAtMost(
          th.getDifference(dennis_ETHWithdrawn, "122461538461538"),
          100000,
        );
        ...
        assert.isAtMost(
          th.getDifference(alice_ETHWithdrawn, "182361204013377"),
          100000,
        );
        assert.isAtMost(
          th.getDifference(bob_ETHWithdrawn, "227951505016722"),
          100000,
        );
        assert.isAtMost(
          th.getDifference(carol_ETHWithdrawn, "113975752508361"),
          100000,
        );
      });
      ...
      it("withdrawFromSP(): A, B, D deposit -> 2 liquidations -> C makes deposit -> 1 liquidation -> D withdraws -> 1 liquidation. All deposits: 100 LUSD. Liquidations: 100,100,100,50.  A, B, C, D withdraw correct LUSD deposit and ETH Gain", async () => {
        ...
        assert.isAtMost(
          th.getDifference(dennis_ETHWithdrawn, "82916666666667"),
          100000,
        );
        ...
        assert.isAtMost(
          th.getDifference(alice_ETHWithdrawn, "92866666666667"),
          10000,
        );
        assert.isAtMost(
          th.getDifference(bob_ETHWithdrawn, "92866666666667"),
          10000,
        );
        assert.isAtMost(
          th.getDifference(carol_ETHWithdrawn, "79600000000000"),
          10000,
        );
      });
      ...
      it("withdrawFromSP(): Depositor withdraws correct compounded deposit after liquidation empties the pool", async () => {
        ...
        assert.isAtMost(
          th.getDifference(carol_ETHWithdrawn, "49750000000000"),
          100000,
        );
        assert.isAtMost(
          th.getDifference(dennis_ETHWithdrawn, "49750000000000"),
      ...
      it("withdrawFromSP(): Depositors withdraw correct compounded deposit after liquidation empties the pool", async () => {
        ...
        const erin_ETHWithdrawn = th
          .getEventArgByName(txE, "CollateralGainWithdrawn", "_collAmount")
          .toString();
        ...
        assert.isAtMost(
          th.getDifference(carol_ETHWithdrawn, "16583333333333"),
          100000,
        );
        assert.isAtMost(
          th.getDifference(dennis_ETHWithdrawn, "33166666666667"),
          100000,
        );
        assert.isAtMost(
          th.getDifference(erin_ETHWithdrawn, "49750000000000"),
          100000,
        );
      });
      ...
      it("withdrawFromSP(): Depositor withdraws correct compounded deposit after liquidation empties the pool", async () => {
        ...
        const flyn_ETHWithdrawn = th
          .getEventArgByName(txF, "CollateralGainWithdrawn", "_collAmount")
          .toString();
        const graham_ETHWithdrawn = th
          .getEventArgByName(txG, "CollateralGainWithdrawn", "_collAmount")
          .toString();
        const harriet_ETHWithdrawn = th
          .getEventArgByName(txH, "CollateralGainWithdrawn", "_collAmount")
          .toString();
      ...
      should only earn ETH from the single liquidation that cancelled with their deposit */
        ...
        assert.isAtMost(
          th.getDifference(erin_ETHWithdrawn, dec(995, 11)),
          100000,
        );
        assert.isAtMost(
          th.getDifference(flyn_ETHWithdrawn, dec(995, 11)),
          100000,
        );
        assert.isAtMost(
          th.getDifference(graham_ETHWithdrawn, dec(995, 11)),
          100000,
        );
        assert.isAtMost(
          th.getDifference(harriet_ETHWithdrawn, dec(995, 11)),
          100000,
        );
      ...
      it("withdrawFromSP(): deposit spans one scale factor change: Single depositor withdraws correct compounded deposit and ETH Gain after one liquidation", async () => {
        ...
        assert.isAtMost(
          th.getDifference(bob_ETHWithdrawn, "59700000000000"),
          100000,
        );
      });
      ...
      it("withdrawFromSP(): Several deposits of varying amounts span one scale factor change. Depositors withdraw correct compounded deposit and ETH Gain after one liquidation", async () => {
        ...
        await mintCollateralAndApproveBorrowerOps(
          collaterals[0],
          defaulter_2,
          dec(330, collDecimals),
        );
        await borrowerOperations.openTrove(
          collaterals[0].address,
          dec(330, collDecimals),
          th._100pct,
          await getOpenTroveLUSDAmount("54450000000000000000000"),
          defaulter_2,
          defaulter_2,
          { from: defaulter_2 },
        );
        ...
        const txL2 = await troveManager.liquidate(
          defaulter_2,
          collaterals[0].address,
          { from: owner },
        );
      ...
      */
        ...
        assert.isAtMost(
          th.getDifference(bob_ETHWithdrawn, "54725000000000"),
          100000,
        );
        assert.isAtMost(
          th.getDifference(carol_ETHWithdrawn, "109450000000000"),
          100000,
        );
        assert.isAtMost(
          th.getDifference(dennis_ETHWithdrawn, "164175000000000"),
          100000,
        );
      });
      ...
      it("withdrawFromSP(): deposit spans one scale factor change: Single depositor withdraws correct compounded deposit and ETH Gain after one liquidation", async () => {
        ...
        const txL1 = await troveManager.liquidate(
          defaulter_1,
          collaterals[0].address,
          { from: owner },
        );
      ...
      it("withdrawFromSP(): Several deposits of varying amounts span one scale factor change. Depositors withdraws correct compounded deposit and ETH Gain after one liquidation", async () => {
        ...
        assert.isAtMost(
          th.getDifference(carol_ETHWithdrawn, dec(1990, 11)),
          1000000,
        );
        assert.isAtMost(
          th.getDifference(dennis_ETHWithdrawn, dec(2985, 11)),
          1000000,
        );
      });
    ...
    */
      it("withdrawFromSP(): Several deposits of 10000 LUSD span one scale factor change. Depositors withdraws correct compounded deposit and ETH Gain after one liquidation", async () => {
        ...
        const txL3 = await troveManager.liquidate(
          defaulter_3,
          collaterals[0].address,
          { from: owner },
        );
        ...
        const txL4 = await troveManager.liquidate(
          defaulter_4,
          collaterals[0].address,
          { from: owner },
        );
      ...
      it("withdrawFromSP(): Depositor's collateral gain stops increasing after two scale changes", async () => {
        ...
        const txL5 = await troveManager.liquidate(
          defaulter_5,
          collaterals[0].address,
          { from: owner },
        );
