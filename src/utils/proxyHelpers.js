...
class Proxy {
  ...
  async proxyFunctionWithUserAndCollateral(functionName, user, collAddress) {
    return this.contract[functionName](
...
class BorrowerWrappersProxy extends Proxy {
  ...
  async claimCollateralAndOpenTrove(...params) {
    return this.forwardFunction(
      params,
      "claimCollateralAndOpenTrove(address,uint256,uint256,uint256,address,address)",
    );
  }
...
class TroveManagerProxy extends Proxy {
  ...
  async getTroveStatus(user, collAddress) {
    return this.proxyFunctionWithUserAndCollateral(
      "getTroveStatus",
      user,
      collAddress,
    );
