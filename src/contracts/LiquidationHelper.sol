...
contract LiquidationHelper is LiquityBase, Ownable, ILiquidationHelper {
    ...
    function _liquidateNormalMode(
        ...
        ) = troveManager.getEntireDebtAndColl(_borrower, _collateral);
    ...
    function _liquidateRecoveryMode(
        ...
        LocalVariables_InnerSingleLiquidateFunction memory vars;
        if (troveManager.getTroveOwnersCount(_collateral) <= 1) {
            return singleLiquidation;
        ...
        if (_ICR <= _100pct) {
            ...
            // if (_ICR >= _MCR && ( _ICR >= _TCR || singleLiquidation.entireTroveDebt > _LUSDInStabPool))
    ...
    function liquidateTroves(
        ...
        require(
            ...
            "LiquidationHelper: Total debt in sequence cannot be zero"
        );
    ...
    function _getTotalsFromLiquidateTrovesSequence_RecoveryMode(
        ...
        for (vars.i = 0; vars.i < _n && vars.user != firstUser; vars.i++) {
            ...
            if (!vars.backToNormalMode) {
                ...
                vars.TCR = LiquityMath._computeCR(
    ...
    function _requireCallerIsTroveManager() internal view {
        require(
            ...
            "LiquidationHelper: Caller is not TroveManager"
        );
    }
}
