...
contract SortedTroves is Ownable, CheckContract, ISortedTroves {
    ...
    function insert (address _collateral, address _id, uint256 _NICR, address _prevId, address _nextId) external override returns (address, address) {
    ...
    function _insert(ITroveManager _troveManager, address _collateral, address _id, uint256 _NICR, address _prevId, address _nextId) internal returns (address, address) {
     ...
     */
    function reInsert(address _id, address _collateral, uint256 _newNICR, address _prevId, address _nextId) external override returns (address, address) {
        ITroveManager troveManagerCached = troveManager;
